...
function CodexButtonClicked()
	...
	if numLearned ~= 0 then
		...
		statusText = statusText .. "^cornflowerblue;Ler: " .. tostring(numLearned) .. "^reset;"
	end
	if numAlreadyKnew ~= 0 then
		...
		if numLearned ~= 0 then
			...
			statusText = statusText .. " ^gray;/^reset; " .. "^cornflowerblue;Sabe: " .. tostring(numAlreadyKnew) .. "^reset;"
		else
			...
			statusText = statusText .. "^cornflowerblue;J? sabe: " .. tostring(numAlreadyKnew) .. "^reset;"
		end
	end
	if numErrored ~= 0 then
		...
		statusText = statusText .. "^red;" .. tostring(numErrored) .. " falha (veja o log)"
	end
